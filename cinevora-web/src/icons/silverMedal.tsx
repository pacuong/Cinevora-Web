...
const SilverMedal = ({ onClick, className, width = 30, height = 40, rank }: SilverMedalProps) => {
  return (
    <svg
      onClick={onClick}
      className={className}
    ...
    >
      ...
      <path
        ...
        fill='#418ED6'
      />
      <circle cx='12.02' cy='11.06' r='11.06' fill='#E3E3E3' />
      <circle cx='12.02' cy='11.06' r='8.63' fill='url(#gradSilver)' />
      <text
        x='12.02'
        y='14'
        textAnchor='middle'
